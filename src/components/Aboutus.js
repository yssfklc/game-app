...
function Aboutus() {
  ...
  return (
    <div className='grid grid-cols-12 grid-rows-4 gap-10'>
        ...
        <div className='col-start-2 col-span-10 row-start-2 row-span-1'>
            <div className='text-gray-100 mt-20 mb-20 font-extrabold text-xl leading-8 tracking-wider'>
                <h2>Why Work Wıth Us</h2>
            </div>
            <div className='flex justify-between'>
                <div className='w-96 bg-gray-100 py-10 h-80 px-10 flex flex-col justify-around items-start rounded-xl'>
        ...
        <div className='col-start-2 col-span-10 row-start-3 row-span-1 flex'>
            <div className='w-1/2 flex items-end justify-start'>
                <img src={g19} alt=''/>
            </div>
            <div className='w-1/2 flex flex-col justify-end items-start p-10'>
                <p className='text-gray-800 mb-20 font-bold'>Lorem Ipsum</p>
                <h1 className='text-gray-800 text-4xl mb-8 font-extrabold leading-relaxed	w-3/4 font-serif'>Work that we produce for our clients</h1>
                <p className='text-gray-800 mb-20'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p> 
            </div>
        </div>
        <div className='col-start-2 col-span-10 row-start-4 row-span-1 '>
            <p className='font-bold my-20 text-gray-100 text-xl'>Our Team</p>
            <div className='flex justify-center items-center mb-20'>
                {employees.map((employee)=>{
                    return (<div className='w-1/4 bg-gray-800 mr-5 py-10 px-5 rounded-xl h-70 flex flex-col items-center justify-center'>
                        <img src={employee[0]}/>
              ...
              <div className='bg-gray-200 rounded-lg py-10 px-5 flex justify-between items-center mb-20'>
                    <div className='w-1/2'>
